    ...
    <div class="col-span-3">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="mb-4">
                ...
                <x-jet-input type="text" dusk="contact-name" wire:model.defer="contact"
            ...
            <div>
                ...
                <x-jet-input type="text" dusk="contact-phone" wire:model.defer="phone" placeholder="Introduzca el teléfono de contacto"
                    class="w-full" />
                    ...
                    <div>
                        ...
                        <select dusk="department" class="form-control w-full" wire:model="department_id">
                            ...
                            @foreach ($departments as $department)
                                <option dusk="option-department" value="{{ $department->id }}">
                    ...
                    <div>
                        ...
                        <select dusk="city" class="form-control w-full" wire:model="city_id">
                            ...
                            @foreach ($cities as $city)
                                <option dusk="option-city" value="{{ $city->id }}">{{ $city->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select dusk="district" class="form-control w-full" wire:model="district_id">
                            ...
                            @foreach ($districts as $district)
                                <option dusk="option-district" value="{{ $district->id }}">{{ $district->name }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div>
            <x-jet-button dusk="create-order" wire:loading.attr="disabled" wire:target="create_order" class="mt-6 mb-4"
